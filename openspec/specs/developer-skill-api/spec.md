# developer-skill-api Specification

## Purpose

Provide read endpoints for individual developers and skills, returning each entity's own fields and only its downstream relationships, with consistent JSON error responses shared with the rest of the API.
